        ...
        private void SetCellsAlongAxis(int axis)
        {
            ...
            for (int i = 0; i < rectChildren.Count; i++)
            {
                ...
                if (expandSetting == ExpandSetting.both)
                {
                    ...
                    {
                        realsizey = ((height - padding.top - padding.bottom - (spacing[0] * (actualCellCountY - 1))) / actualCellCountY);
                    }
                    else
                    {
                        realsizey = ((height / constraintCount - padding.top - padding.bottom - (spacing[0] * (actualCellCountY - 1))) / actualCellCountY);
